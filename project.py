...
def soups_salads():
    ...
    label = Label(root2, text = ' ' , bg = 'light blue').grid(row = 2, column = 20)
    label = Label(root2, text = ' ' , bg = 'light blue').grid(row = 2, column = 21)
    b1 = Button(root2, text = 'Click here to order Tomato Soup' , command = lambda:bill('Tomato Soup', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 5, column = 22)
    b2 = Button(root2, text = 'Click here to order Manchow Soup' , command = lambda:bill('Manchow Soup', 140), highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 6, column = 22)
    b3 = Button(root2, text = 'Click here to order Cream of Mushroom' , command = lambda:bill('Cream of Mushroom', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 7, column = 22)
    b4 = Button(root2, text = 'Click here to order Cream of Chicken' , command = lambda:bill('Cream of Chicken', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 8, column = 22)
    b5 = Button(root2, text = 'Click here to order Hot and Sour Soup' , command = lambda:bill('Hot and Sour Soup', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 9, column = 22)
    b6 = Button(root2, text = 'Click here to order Clear Soup' , command = lambda:bill('Clear Soup', 120) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 10, column = 22)
    b7 = Button(root2, text = 'Click here to order Pasta Salad' , command = lambda:bill('Pasta Salad', 160) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 13, column = 22)
    b8 = Button(root2, text = 'Click here to order Caesar Salad' , command = lambda:bill('Caesar Salad', 160) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 14, column = 22)
    b9 = Button(root2, text = 'Click here to order Russian Salad' , command = lambda:bill('Russian Salad', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 15, column = 22)
    b10 = Button(root2, text = 'Click here to order Greek Salad' , command = lambda:bill('Greek Salad', 160) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 16, column = 22)
    b11 = Button(root2, text = 'Click here to order Crunchy Chicken Salad' , command = lambda:bill('Crunchy Chicken Salad', 210) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 17, column = 22)
    b12 = Button(root2, text = 'Click here to order Mexican Nachos Grande' , command = lambda:bill('Mexican Nachos Grande', 210) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 18, column = 22)
    b13 = Button(root2, text = 'Click here to order Omlette(Served with toast)' , command = lambda:bill('Omlette(Served with toast)', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 24, column = 22)
    b14 = Button(root2, text = 'Click here to order Scrambled Eggs' , command = lambda:bill('Scrambled Eggs', 110) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 25, column = 22)
    b15 = Button(root2, text = 'Click here to order Fried Eggs' , command = lambda:bill('Fried Eggs', 110) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 26, column = 22)
    b16 = Button(root2, text = 'Click here to order French Toast(Served with Maple Syrup)' , command = lambda:bill('French Toast(Served with Maple Syrup)', 100) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 27, column = 22)
...
def appetizers():
    ...
    b17 = Button(root3, text = 'Click here to order Chilli Paneer' , command = lambda:bill('Chilli Paneer', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 5, column = 22)
    b18 = Button(root3, text = 'Click here to order Chilli Potato' , command = lambda:bill('Chilli Potato', 200), highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 6, column = 22)
    b19 = Button(root3, text = 'Click here to order Thai BBQ Cottage Cheese' , command = lambda:bill('Thai BBQ Cottage Cheese', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 7, column = 22)
    b20 = Button(root3, text = 'Click here to order Salt and Pepper Baby Corn' , command = lambda:bill('Salt and Pepper Baby Corn', 200) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 8, column = 22)
    b21 = Button(root3, text = 'Click here to order Spring Rolls' , command = lambda:bill('Spring Rolls', 200) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 9, column = 22)
    b22 = Button(root3, text = 'Click here to order Chilli Chicken' , command = lambda:bill('Chilli Chicken', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 10, column = 22)
    b23 = Button(root3, text = 'Click here to order Salt and Pepper Chicken' , command = lambda:bill('Salt and Pepper Chicken', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 11, column = 22)
    b24 = Button(root3, text = 'Click here to order Fish in Chilli Mustard' , command = lambda:bill('Fish in Chilli Mustard', 450) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 12, column = 22)
    b25 = Button(root3, text = 'Click here to order Korean Chilli Prawns' , command = lambda:bill('Korean Chilli Prawns', 400) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 13, column = 22)
    b26 = Button(root3, text = 'Click here to order Paneer Tikka' , command = lambda:bill('Paneer Tikka', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 14, column = 22)
    b27 = Button(root3, text = 'Click here to order Tandoori Stuffed Mushroom' , command = lambda:bill('Tandoori Stuffed Mushroom', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 15, column = 22)
    b28 = Button(root3, text = 'Click here to order Fried Peanut Masala' , command = lambda:bill('Fried Peanut Masala', 200) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 16, column = 22)
    b29 = Button(root3, text = 'Click here to order Chicken Tikka' , command = lambda:bill('Chicken Tikka', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 17, column = 22)
    b30 = Button(root3, text = 'Click here to order Ghee Roast Chicken' , command = lambda:bill('Ghee Roast Chicken', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 18, column = 22)
    b31 = Button(root3, text = 'Click here to order Thai Curry and Garlic Rice' , command = lambda:bill('Thai Curry and Garlic Rice', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 23, column = 22)
    b32 = Button(root3, text = 'Click here to order Stir Fry Noodles' , command = lambda:bill('Stir Fry Noodles', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 24, column = 22)
    b33 = Button(root3, text = 'Click here to order Rice Bowl' , command = lambda:bill('Rice Bowl', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 25, column = 22)
...
def pizza():
    ...
    label = Label(root4, text = ' ' , bg = 'light blue').grid(row = 2, column = 20)
    label = Label(root4, text = ' ' , bg = 'light blue').grid(row = 2, column = 21)
    b34 = Button(root4, text = 'Click here to order Margherita' , command = lambda:bill('Margherita', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 5, column = 22)
    b35 = Button(root4, text = 'Click here to order Garden Pizza' , command = lambda:bill('Garden Pizza', 350), highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 6, column = 22)
    b36 = Button(root4, text = 'Click here to order Peri Peri Fanatics' , command = lambda:bill('Peri Peri Fanatics', 400) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 7, column = 22)
    b37 = Button(root4, text = 'Click here to order Indian Tikka Pizza' , command = lambda:bill('Indian Tikka Pizza', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 8, column = 22)
    b38 = Button(root4, text = 'Click here to order Meat Lovers' , command = lambda:bill('Meat Lovers', 450) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 9, column = 22)
    b39 = Button(root4, text = 'Click here to order Pepperoni pizza' , command = lambda:bill('Pepperoni pizza', 450) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 10, column = 22)
    b40 = Button(root4, text = 'Click here to order Pesto' , command = lambda:bill('Pesto', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 15, column = 22)
    b41 = Button(root4, text = 'Click here to order Pasta Arabiata' , command = lambda:bill('Pasta Arabiata', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 16, column = 22)
    b42 = Button(root4, text = 'Click here to order Creamy Cheese Sauce' , command = lambda:bill('Creamy Cheese Sauce', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 17, column = 22)
    b43 = Button(root4, text = 'Click here to order Italian Pasta Alfredo' , command = lambda:bill('Italian Pasta Alfredo', 400) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 18, column = 22)
    b44 = Button(root4, text = 'Click here to order Olive Blasta Pasta' , command = lambda:bill('Olive Blasta Pasta', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 19, column = 22)
    b45 = Button(root4, text = 'Click here to order Spaghetti Carbanora(Chicken' , command = lambda:bill('Spaghetti Carbanora(Chicken', 400) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 20, column = 22)
    b46 = Button(root4, text = 'Click here to order Crunchy Veg Burger' , command = lambda:bill('Crunchy Veg Burger', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 24, column = 22)
    b47 = Button(root4, text = 'Click here to order Cottage Cheese Burger' , command = lambda:bill('Cottage Cheese Burger', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 25, column = 22)
    b48 = Button(root4, text = 'Click here to order Peri Peri Paneer' , command = lambda:bill('Peri Peri Paneer', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 26, column = 22)
    b49 = Button(root4, text = 'Click here to order Tex Mex Chicken Burger' , command = lambda:bill('Tex Mex Chicken Burger', 400) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 27, column = 22)
    b50 = Button(root4, text = 'Click here to order Lamb Burger' , command = lambda:bill('Lamb Burger', 450) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 28, column = 22)
    b51 = Button(root4, text = 'Click here to order Fish Fillet Burger' , command = lambda:bill('Fish Fillet Burger', 450) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 29, column = 22)
...
def beverages():
    ...
    label = Label(root5, text = ' ' , bg = 'light blue').grid(row = 2, column = 20)
    label = Label(root5, text = ' ' , bg = 'light blue').grid(row = 2, column = 21)
    b52 = Button(root5, text = 'Click here to order Blue Curacao' , command = lambda:bill('Blue Curacao', 110) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 5, column = 22)
    b53 = Button(root5, text = 'Click here to order Green Apple' , command = lambda:bill('Green Apple', 110), highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 6, column = 22)
    b54 = Button(root5, text = 'Click here to order Lime Juice' , command = lambda:bill('Lime Juice', 110) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 7, column = 22)
    b55 = Button(root5, text = 'Click here to order Strawberry Milkshake' , command = lambda:bill('Strawberry Milkshake', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 8, column = 22)
    b56 = Button(root5, text = 'Click here to order Virgin Mojito' , command = lambda:bill('Virgin Mojito', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 9, column = 22)
    b57 = Button(root5, text = 'Click here to order Lemon Ice Tea' , command = lambda:bill('Lemon Ice Tea', 100) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 10, column = 22)
    b58 = Button(root5, text = 'Click here to order Ferroro Rocher Shake' , command = lambda:bill('Ferroro Rocher Shake', 170) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 11, column = 22)
    b59 = Button(root5, text = 'Click here to order Oreo Shake' , command = lambda:bill('Oreo Shake', 170) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 12, column = 22)
    b60 = Button(root5, text = 'Click here to order Irish Cold Coffee' , command = lambda:bill('Irish Cold Coffee', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 13, column = 22)
    b61 = Button(root5, text = 'Click here to order Choco Mocha' , command = lambda:bill('Choco Mocha', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 14, column = 22)
    b62 = Button(root5, text = 'Click here to order Hot Coffee' , command = lambda:bill('Hot Coffee', 100) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 15, column = 22)
    b63 = Button(root5, text = 'Click here to order Blueberry Shake' , command = lambda:bill('Blueberry Shake', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 16, column = 22)
    b64 = Button(root5, text = 'Click here to order Coca Cola' , command = lambda:bill('Coca Cola', 100) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 17, column = 22)
    b65 = Button(root5, text = 'Click here to order Red Bull' , command = lambda:bill('Red Bull', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 18, column = 22)
...
def desserts():
    ...
    label = Label(root6, text = ' ' , bg = 'light blue').grid(row = 2, column = 20)
    label = Label(root6, text = ' ' , bg = 'light blue').grid(row = 2, column = 21)
    b52 = Button(root6, text = 'Click here to order Black Forest' , command = lambda:bill('Black Forest', 120) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 5, column = 22)
    b53 = Button(root6, text = 'Click here to order Ferroro Rocher Cake' , command = lambda:bill('Ferroro Rocher Cake', 150), highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 6, column = 22)
    b54 = Button(root6, text = 'Click here to order Almond and Chcocolate Fudge' , command = lambda:bill('Almond and Chcocolate Fudge', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 7, column = 22)
    b55 = Button(root6, text = 'Click here to order Choco Mousse' , command = lambda:bill('Choco Mousse', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 8, column = 22)
    b56 = Button(root6, text = 'Click here to order Red Velvet' , command = lambda:bill('Red Velvet', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 9, column = 22)
    b57 = Button(root6, text = 'Click here to order Kitkat Cake' , command = lambda:bill('Kitkat Cake', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 10, column = 22)
    b58 = Button(root6, text = 'Click here to order Chocolate Truffle' , command = lambda:bill('Chocolate Truffle', 170) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 11, column = 22)
    b59 = Button(root6, text = 'Click here to order Apple Pie' , command = lambda:bill('Apple Pie', 170) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 12, column = 22)
    b60 = Button(root6, text = 'Click here to order Mississippi Mud Pie' , command = lambda:bill('Mississippi Mud Pie', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 13, column = 22)
    b61 = Button(root6, text = 'Click here to order Choco Lava Cake' , command = lambda:bill('Choco Lava Cake', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 14, column = 22)
    b62 = Button(root6, text = 'Click here to order Tiramisu' , command = lambda:bill('Tiramisu', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 15, column = 22)
    b63 = Button(root6, text = 'Click here to order Oreo Cheese Cake' , command = lambda:bill('Oreo Cheese Cake', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 16, column = 22)
    b64 = Button(root6, text = 'Click here to order Blueberry Cheese Cake' , command = lambda:bill('Blueberry Cheese Cake', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 17, column = 22)
    b65 = Button(root6, text = 'Click here to order Cappuccino Walnut Brownie' , command = lambda:bill('Cappuccino Walnut Brownie', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 18, column = 22)
    b64 = Button(root6, text = 'Click here to order Choclate Tart' , command = lambda:bill('Choclate Tart', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 19, column = 22)
    b65 = Button(root6, text = 'Click here to order Liquid Lemon Cheese Cake' , command = lambda:bill('Liquid Lemon Cheese Cake', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 20, column = 22)
