...
def book_table():
    ...
    label2 = Label(root1, text = "Please enter the number of seats you want to book: " , bg = "light grey", font = ("Times New Roman",20,"bold"))
    ...
    button3 = Button(root1, text = 'Click here to view the menu' , command = soups_salads, highlightbackground = "light grey", font = ("Times New Roman",25,"bold"))
...
#Defining function to confirm the table
    def welcome():
        ...
        if a<=25:
            ...
            label3 = Label(root1, text = message1 , bg = "light grey", fg = "black", font = ("Times New Roman",20,"bold"))
            ...
            label4 = Label(root1, text = message2, bg = "light grey", fg = "black", font = ("Times New Roman",20,"bold"))
            label4.place(relx = 0.5 , rely = 0.5 , anchor = 'center')
    label = Label(root1, text = ' ' , bg = 'light blue').grid(row = 5, column = 5)
    button2 = Button(root1, width = 25, text = 'Click here to enter', command = welcome, highlightbackground="light grey", font = ("Times New Roman",16,"bold"))
    button2.grid(row = 6, column = 5)

#Creating button to book table 
button1 = Button(root, text='Click here to book a table', command = book_table, highlightbackground = "light grey", font = ("Times New Roman",25,"bold"))
...
def soups_salads():
    ...
    label5 = Label(root2, text = "SOUPS & SALADS", bg = 'light grey',font = ("Times New Roman",27,"bold"))
    ...
    label18 = Label(root2, text = "EGGS TO ORDER", bg = 'light grey',font = ("Times New Roman",27,"bold")).grid(row = 21, column = 8)
    ...
    label23 = Label(root2, text = "PRICES", bg = 'light grey',font = ("Times New Roman",27,"bold"))
    ...
    button4 = Button(root2, text = 'Click here to view further' , command = appetizers, highlightbackground = "light grey", font = ("Times New Roman",25,"bold"))
    ...
    b1 = Button(root2, text = '0rder ' , command = lambda:bill('Tomato Soup', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 5, column = 22)
    b2 = Button(root2, text = '0rder ' , command = lambda:bill('Manchow Soup', 140), highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 6, column = 22)
    b3 = Button(root2, text = '0rder ' , command = lambda:bill('Cream of Mushroom', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 7, column = 22)
    b4 = Button(root2, text = '0rder ' , command = lambda:bill('Cream of Chicken', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 8, column = 22)
    b5 = Button(root2, text = '0rder ' , command = lambda:bill('Hot and Sour Soup', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 9, column = 22)
    b6 = Button(root2, text = '0rder ' , command = lambda:bill('Clear Soup', 120) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 10, column = 22)
    b7 = Button(root2, text = '0rder ' , command = lambda:bill('Pasta Salad', 160) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 13, column = 22)
    b8 = Button(root2, text = '0rder ' , command = lambda:bill('Caesar Salad', 160) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 14, column = 22)
    b9 = Button(root2, text = '0rder ' , command = lambda:bill('Russian Salad', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 15, column = 22)
    b10 = Button(root2, text = '0rder ' , command = lambda:bill('Greek Salad', 160) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 16, column = 22)
    b11 = Button(root2, text = '0rder ' , command = lambda:bill('Crunchy Chicken Salad', 210) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 17, column = 22)
    b12 = Button(root2, text = '0rder ' , command = lambda:bill('Mexican Nachos Grande', 210) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 18, column = 22)
    b13 = Button(root2, text = '0rder ' , command = lambda:bill('Omlette(Served with toast)', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 24, column = 22)
    b14 = Button(root2, text = '0rder ' , command = lambda:bill('Scrambled Eggs', 110) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 25, column = 22)
    b15 = Button(root2, text = '0rder ' , command = lambda:bill('Fried Eggs', 110) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 26, column = 22)
    b16 = Button(root2, text = '0rder ' , command = lambda:bill('French Toast(Served with Maple Syrup)', 100) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 27, column = 22)
    label = Label(root2, text = ' ' , bg = 'light blue').grid(row = 2, column = 23)
    label = Label(root2, text = ' ' , bg = 'light blue').grid(row = 2, column = 24)
#Cancel
    b1 = Button(root2, text = 'Cancel ' , command = lambda:cancel('Tomato Soup', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 5, column = 25)
    b2 = Button(root2, text = 'Cancel ' , command = lambda:cancel('Manchow Soup', 140), highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 6, column = 25)
    b3 = Button(root2, text = 'Cancel ' , command = lambda:cancel('Cream of Mushroom', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 7, column = 25)
    b4 = Button(root2, text = 'Cancel ' , command = lambda:cancel('Cream of Chicken', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 8, column = 25)
    b5 = Button(root2, text = 'Cancel ' , command = lambda:cancel('Hot and Sour Soup', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 9, column = 25)
    b6 = Button(root2, text = 'Cancel ' , command = lambda:cancel('Clear Soup', 120) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 10, column = 25)
    b7 = Button(root2, text = 'Cancel ' , command = lambda:cancel('Pasta Salad', 160) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 13, column = 25)
    b8 = Button(root2, text = 'Cancel ' , command = lambda:cancel('Caesar Salad', 160) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 14, column = 25)
    b9 = Button(root2, text = 'Cancel ' , command = lambda:cancel('Russian Salad', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 15, column = 25)
    b10 = Button(root2, text = 'Cancel ' , command = lambda:cancel('Greek Salad', 160) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 16, column = 25)
    b11 = Button(root2, text = 'Cancel ' , command = lambda:cancel('Crunchy Chicken Salad', 210) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 17, column = 25)
    b12 = Button(root2, text = 'Cancel ' , command = lambda:cancel('Mexican Nachos Grande', 210) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 18, column = 25)
    b13 = Button(root2, text = 'Cancel ' , command = lambda:cancel('Omlette(Served with toast)', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 24, column = 25)
    b14 = Button(root2, text = 'Cancel ' , command = lambda:cancel('Scrambled Eggs', 110) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 25, column = 25)
    b15 = Button(root2, text = 'Cancel ' , command = lambda:cancel('Fried Eggs', 110) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 26, column = 25)
    b16 = Button(root2, text = 'Cancel ' , command = lambda:cancel('French Toast(Served with Maple Syrup)', 100) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 27, column = 25)
...
def appetizers():
    ...
    label40 = Label(root3, text = "APPETIZERS", bg = 'light grey',font = ("Times New Roman",27,"bold"))
    ...
    label54 = Label(root3, text = "ORIENTAL BOWLS", bg = 'light grey',font = ("Times New Roman",27,"bold")).grid(row = 21, column = 8)
    ...
    label58 = Label(root3, text = "PRICES", bg = 'light grey',font = ("Times New Roman",27,"bold"))
    ...
    button5 = Button(root3, text = 'Click here to view further' , command = pizza, highlightbackground = "light grey", font = ("Times New Roman",25,"bold"))
    ...
    b17 = Button(root3, text = '0rder ' , command = lambda:bill('Chilli Paneer', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 5, column = 22)
    b18 = Button(root3, text = '0rder ' , command = lambda:bill('Chilli Potato', 200), highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 6, column = 22)
    b19 = Button(root3, text = '0rder ' , command = lambda:bill('Thai BBQ Cottage Cheese', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 7, column = 22)
    b20 = Button(root3, text = '0rder ' , command = lambda:bill('Salt and Pepper Baby Corn', 200) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 8, column = 22)
    b21 = Button(root3, text = '0rder ' , command = lambda:bill('Spring Rolls', 200) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 9, column = 22)
    b22 = Button(root3, text = '0rder ' , command = lambda:bill('Chilli Chicken', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 10, column = 22)
    b23 = Button(root3, text = '0rder ' , command = lambda:bill('Salt and Pepper Chicken', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 11, column = 22)
    b24 = Button(root3, text = '0rder ' , command = lambda:bill('Fish in Chilli Mustard', 450) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 12, column = 22)
    b25 = Button(root3, text = '0rder ' , command = lambda:bill('Korean Chilli Prawns', 400) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 13, column = 22)
    b26 = Button(root3, text = '0rder ' , command = lambda:bill('Paneer Tikka', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 14, column = 22)
    b27 = Button(root3, text = '0rder ' , command = lambda:bill('Tandoori Stuffed Mushroom', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 15, column = 22)
    b28 = Button(root3, text = '0rder ' , command = lambda:bill('Fried Peanut Masala', 200) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 16, column = 22)
    b29 = Button(root3, text = '0rder ' , command = lambda:bill('Chicken Tikka', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 17, column = 22)
    b30 = Button(root3, text = '0rder ' , command = lambda:bill('Ghee Roast Chicken', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 18, column = 22)
    b31 = Button(root3, text = '0rder ' , command = lambda:bill('Thai Curry and Garlic Rice', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 23, column = 22)
    b32 = Button(root3, text = '0rder ' , command = lambda:bill('Stir Fry Noodles', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 24, column = 22)
    b33 = Button(root3, text = '0rder ' , command = lambda:bill('Rice Bowl', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 25, column = 22)
    label = Label(root3, text = ' ' , bg = 'light blue').grid(row = 2, column = 23)
    label = Label(root3, text = ' ' , bg = 'light blue').grid(row = 2, column = 24)

    #Cancel
    b17 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Chilli Paneer', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 5, column = 25)
    b18 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Chilli Potato', 200), highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 6, column = 25)
    b19 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Thai BBQ Cottage Cheese', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 7, column = 25)
    b20 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Salt and Pepper Baby Corn', 200) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 8, column = 25)
    b21 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Spring Rolls', 200) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 9, column = 25)
    b22 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Chilli Chicken', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 10, column = 25)
    b23 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Salt and Pepper Chicken', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 11, column = 25)
    b24 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Fish in Chilli Mustard', 450) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 12, column = 25)
    b25 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Korean Chilli Prawns', 400) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 13, column = 25)
    b26 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Paneer Tikka', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 14, column = 25)
    b27 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Tandoori Stuffed Mushroom', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 15, column = 25)
    b28 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Fried Peanut Masala', 200) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 16, column = 25)
    b29 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Chicken Tikka', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 17, column = 25)
    b30 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Ghee Roast Chicken', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 18, column = 25)
    b31 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Thai Curry and Garlic Rice', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 23, column = 25)
    b32 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Stir Fry Noodles', 250) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 24, column = 25)
    b33 = Button(root3, text = 'Cancel ' , command = lambda:cancel('Rice Bowl', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 25, column = 25)
def pizza():
    root4 = Tk()
    ...
    label76 = Label(root4, text = "PIZZAS", bg = 'light grey',font = ("Times New Roman",27,"bold"))
    ...
    label83 = Label(root4, text = "PASTA", bg = 'light grey',font = ("Times New Roman",27,"bold")).grid(row = 13, column = 8)
    ...
    label90 = Label(root4, text = "BURGERS", bg = 'light grey',font = ("Times New Roman",27,"bold"))
    ...
    label97 = Label(root4, text = "PRICES", bg = 'light grey',font = ("Times New Roman",27,"bold"))
    ...
    button6 = Button(root4, text = 'Click here to view further' , command = beverages, highlightbackground = "light grey", font = ("Times New Roman",25,"bold"))
    ...
    b34 = Button(root4, text = '0rder ' , command = lambda:bill('Margherita', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 5, column = 22)
    b35 = Button(root4, text = '0rder ' , command = lambda:bill('Garden Pizza', 350), highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 6, column = 22)
    b36 = Button(root4, text = '0rder ' , command = lambda:bill('Peri Peri Fanatics', 400) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 7, column = 22)
    b37 = Button(root4, text = '0rder ' , command = lambda:bill('Indian Tikka Pizza', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 8, column = 22)
    b38 = Button(root4, text = '0rder ' , command = lambda:bill('Meat Lovers', 450) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 9, column = 22)
    b39 = Button(root4, text = '0rder ' , command = lambda:bill('Pepperoni pizza', 450) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 10, column = 22)
    b40 = Button(root4, text = '0rder ' , command = lambda:bill('Pesto', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 15, column = 22)
    b41 = Button(root4, text = '0rder ' , command = lambda:bill('Pasta Arabiata', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 16, column = 22)
    b42 = Button(root4, text = '0rder ' , command = lambda:bill('Creamy Cheese Sauce', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 17, column = 22)
    b43 = Button(root4, text = '0rder ' , command = lambda:bill('Italian Pasta Alfredo', 400) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 18, column = 22)
    b44 = Button(root4, text = '0rder ' , command = lambda:bill('Olive Blasta Pasta', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 19, column = 22)
    b45 = Button(root4, text = '0rder ' , command = lambda:bill('Spaghetti Carbanora(Chicken', 400) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 20, column = 22)
    b46 = Button(root4, text = '0rder ' , command = lambda:bill('Crunchy Veg Burger', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 24, column = 22)
    b47 = Button(root4, text = '0rder ' , command = lambda:bill('Cottage Cheese Burger', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 25, column = 22)
    b48 = Button(root4, text = '0rder ' , command = lambda:bill('Peri Peri Paneer', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 26, column = 22)
    b49 = Button(root4, text = '0rder ' , command = lambda:bill('Tex Mex Chicken Burger', 400) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 27, column = 22)
    b50 = Button(root4, text = '0rder ' , command = lambda:bill('Lamb Burger', 450) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 28, column = 22)
    b51 = Button(root4, text = '0rder ' , command = lambda:bill('Fish Fillet Burger', 450) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 29, column = 22)
    label = Label(root4, text = ' ' , bg = 'light blue').grid(row = 2, column = 23)
    label = Label(root4, text = ' ' , bg = 'light blue').grid(row = 2, column = 24)


    b34 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Margherita', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 5, column = 25)
    b35 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Garden Pizza', 350), highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 6, column = 25)
    b36 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Peri Peri Fanatics', 400) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 7, column = 25)
    b37 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Indian Tikka Pizza', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 8, column = 25)
    b38 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Meat Lovers', 450) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 9, column = 25)
    b39 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Pepperoni pizza', 450) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 10, column = 25)
    b40 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Pesto', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 15, column = 25)
    b41 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Pasta Arabiata', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 16, column = 25)
    b42 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Creamy Cheese Sauce', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 17, column = 25)
    b43 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Italian Pasta Alfredo', 400) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 18, column = 25)
    b44 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Olive Blasta Pasta', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 19, column = 25)
    b45 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Spaghetti Carbanora(Chicken', 400) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 20, column = 25)
    b46 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Crunchy Veg Burger', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 24, column = 25)
    b47 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Cottage Cheese Burger', 300) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 25, column = 25)
    b48 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Peri Peri Paneer', 350) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 26, column = 25)
    b49 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Tex Mex Chicken Burger', 400) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 27, column = 25)
    b50 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Lamb Burger', 450) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 28, column = 25)
    b51 = Button(root4, text = 'Cancel ' , command = lambda:cancel('Fish Fillet Burger', 450) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 29, column = 25)
...
def beverages():
    ...
    label116 = Label(root5, text = "BEVERAGES", bg = 'light grey',font = ("Times New Roman",27,"bold"))
    ...
    label131 = Label(root5, text = "PRICES", bg = 'light grey',font = ("Times New Roman",27,"bold"))
    ...
    button7 = Button(root5, text = 'Click here to view further' , command = desserts, highlightbackground = "light grey", font = ("Times New Roman",25,"bold"))
    ...
    b52 = Button(root5, text = '0rder ' , command = lambda:bill('Blue Curacao', 110) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 5, column = 22)
    b53 = Button(root5, text = '0rder ' , command = lambda:bill('Green Apple', 110), highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 6, column = 22)
    b54 = Button(root5, text = '0rder ' , command = lambda:bill('Lime Juice', 110) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 7, column = 22)
    b55 = Button(root5, text = '0rder ' , command = lambda:bill('Strawberry Milkshake', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 8, column = 22)
    b56 = Button(root5, text = '0rder ' , command = lambda:bill('Virgin Mojito', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 9, column = 22)
    b57 = Button(root5, text = '0rder ' , command = lambda:bill('Lemon Ice Tea', 100) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 10, column = 22)
    b58 = Button(root5, text = '0rder ' , command = lambda:bill('Ferroro Rocher Shake', 170) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 11, column = 22)
    b59 = Button(root5, text = '0rder ' , command = lambda:bill('Oreo Shake', 170) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 12, column = 22)
    b60 = Button(root5, text = '0rder ' , command = lambda:bill('Irish Cold Coffee', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 13, column = 22)
    b61 = Button(root5, text = '0rder ' , command = lambda:bill('Choco Mocha', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 14, column = 22)
    b62 = Button(root5, text = '0rder ' , command = lambda:bill('Hot Coffee', 100) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 15, column = 22)
    b63 = Button(root5, text = '0rder ' , command = lambda:bill('Blueberry Shake', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 16, column = 22)
    b64 = Button(root5, text = '0rder ' , command = lambda:bill('Coca Cola', 100) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 17, column = 22)
    b65 = Button(root5, text = '0rder ' , command = lambda:bill('Red Bull', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 18, column = 22)
    label = Label(root5, text = ' ' , bg = 'light blue').grid(row = 2, column = 23)
    label = Label(root5, text = ' ' , bg = 'light blue').grid(row = 2, column = 24)

    #Cancel
    b52 = Button(root5, text = 'Cancel ' , command = lambda:cancel('Blue Curacao', 110) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 5, column = 25)
    b53 = Button(root5, text = 'Cancel ' , command = lambda:cancel('Green Apple', 110), highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 6, column = 25)
    b54 = Button(root5, text = 'Cancel ' , command = lambda:cancel('Lime Juice', 110) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 7, column = 25)
    b55 = Button(root5, text = 'Cancel ' , command = lambda:cancel('Strawberry Milkshake', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 8, column = 25)
    b56 = Button(root5, text = 'Cancel ' , command = lambda:cancel('Virgin Mojito', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 9, column = 25)
    b57 = Button(root5, text = 'Cancel ' , command = lambda:cancel('Lemon Ice Tea', 100) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 10, column = 25)
    b58 = Button(root5, text = 'Cancel ' , command = lambda:cancel('Ferroro Rocher Shake', 170) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 11, column = 25)
    b59 = Button(root5, text = 'Cancel ' , command = lambda:cancel('Oreo Shake', 170) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 12, column = 25)
    b60 = Button(root5, text = 'Cancel ' , command = lambda:cancel('Irish Cold Coffee', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 13, column = 25)
    b61 = Button(root5, text = 'Cancel ' , command = lambda:cancel('Choco Mocha', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 14, column = 25)
    b62 = Button(root5, text = 'Cancel ' , command = lambda:cancel('Hot Coffee', 100) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 15, column = 25)
    b63 = Button(root5, text = 'Cancel ' , command = lambda:cancel('Blueberry Shake', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 16, column = 25)
    b64 = Button(root5, text = 'Cancel ' , command = lambda:cancel('Coca Cola', 100) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 17, column = 25)
    b65 = Button(root5, text = 'Cancel ' , command = lambda:cancel('Red Bull', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 18, column = 25)
...
def desserts():
    ...
    label146 = Label(root6, text = "DESSERTS", bg = 'light grey',font = ("Times New Roman",27,"bold"))
    ...
    label163 = Label(root6, text = "PRICES", bg = 'light grey',font = ("Times New Roman",27,"bold"))
    ...
    button8 = Button(root6, text = 'Click here to play some games while you wait for the order' , command = games , highlightbackground = "light grey", font = ("Times New Roman",23,"bold"))
    ...
    b52 = Button(root6, text = '0rder ' , command = lambda:bill('Black Forest', 120) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 5, column = 22)
    b53 = Button(root6, text = '0rder ' , command = lambda:bill('Ferroro Rocher Cake', 150), highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 6, column = 22)
    b54 = Button(root6, text = '0rder ' , command = lambda:bill('Almond and Chcocolate Fudge', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 7, column = 22)
    b55 = Button(root6, text = '0rder ' , command = lambda:bill('Choco Mousse', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 8, column = 22)
    b56 = Button(root6, text = '0rder ' , command = lambda:bill('Red Velvet', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 9, column = 22)
    b57 = Button(root6, text = '0rder ' , command = lambda:bill('Kitkat Cake', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 10, column = 22)
    b58 = Button(root6, text = '0rder ' , command = lambda:bill('Chocolate Truffle', 170) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 11, column = 22)
    b59 = Button(root6, text = '0rder ' , command = lambda:bill('Apple Pie', 170) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 12, column = 22)
    b60 = Button(root6, text = '0rder ' , command = lambda:bill('Mississippi Mud Pie', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 13, column = 22)
    b61 = Button(root6, text = '0rder ' , command = lambda:bill('Choco Lava Cake', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 14, column = 22)
    b62 = Button(root6, text = '0rder ' , command = lambda:bill('Tiramisu', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 15, column = 22)
    b63 = Button(root6, text = '0rder ' , command = lambda:bill('Oreo Cheese Cake', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 16, column = 22)
    b64 = Button(root6, text = '0rder ' , command = lambda:bill('Blueberry Cheese Cake', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 17, column = 22)
    b65 = Button(root6, text = '0rder ' , command = lambda:bill('Cappuccino Walnut Brownie', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 18, column = 22)
    b64 = Button(root6, text = '0rder ' , command = lambda:bill('Choclate Tart', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 19, column = 22)
    b65 = Button(root6, text = '0rder ' , command = lambda:bill('Liquid Lemon Cheese Cake', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 20, column = 22)
    label = Label(root6, text = ' ' , bg = 'light blue').grid(row = 2, column = 23)
    label = Label(root6, text = ' ' , bg = 'light blue').grid(row = 2, column = 24)

    #Cancel
    b52 = Button(root6, text = 'Cancel ' , command = lambda:cancel('Black Forest', 120) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 5, column = 25)
    b53 = Button(root6, text = 'Cancel ' , command = lambda:cancel('Ferroro Rocher Cake', 150), highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 6, column = 25)
    b54 = Button(root6, text = 'Cancel ' , command = lambda:cancel('Almond and Chcocolate Fudge', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 7, column = 25)
    b55 = Button(root6, text = 'Cancel ' , command = lambda:cancel('Choco Mousse', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 8, column = 25)
    b56 = Button(root6, text = 'Cancel ' , command = lambda:cancel('Red Velvet', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 9, column = 25)
    b57 = Button(root6, text = 'Cancel ' , command = lambda:cancel('Kitkat Cake', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 10, column = 25)
    b58 = Button(root6, text = 'Cancel ' , command = lambda:cancel('Chocolate Truffle', 170) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 11, column = 25)
    b59 = Button(root6, text = 'Cancel ' , command = lambda:cancel('Apple Pie', 170) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 12, column = 25)
    b60 = Button(root6, text = 'Cancel ' , command = lambda:cancel('Mississippi Mud Pie', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 13, column = 25)
    b61 = Button(root6, text = 'Cancel ' , command = lambda:cancel('Choco Lava Cake', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 14, column = 25)
    b62 = Button(root6, text = 'Cancel ' , command = lambda:cancel('Tiramisu', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 15, column = 25)
    b63 = Button(root6, text = 'Cancel ' , command = lambda:cancel('Oreo Cheese Cake', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 16, column = 25)
    b64 = Button(root6, text = 'Cancel ' , command = lambda:cancel('Blueberry Cheese Cake', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 17, column = 25)
    b65 = Button(root6, text = 'Cancel ' , command = lambda:cancel('Cappuccino Walnut Brownie', 150) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 18, column = 25)
    b64 = Button(root6, text = 'Cancel ' , command = lambda:cancel('Choclate Tart', 140) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 19, column = 25)
    b65 = Button(root6, text = 'Cancel ' , command = lambda:cancel('Liquid Lemon Cheese Cake', 130) , highlightbackground = "light grey", font = ("Times New Roman",15,"bold")).grid(row = 20, column = 25)
...
def display():
    ...
    ld1 = Label(root8, text = "Your order is ready! Please enjoy", bg = 'light grey', font = ('Times New Roman', 30, 'bold')).place(relx = 0.65, rely = 0.4, anchor = 'ne')
...
def bill_display():
    ...
    lb3 = Label(root9, text = 'Dish', bg = 'light grey', font = ('Times New Roman', 20, 'bold')).grid(row = 6, column = 8)
    lb4 = Label(root9, text = 'Price', bg = 'light grey', font = ('Times New Roman', 20, 'bold')).grid(row = 6, column = 41)
    ...
    bd1 = Button(root9, text = "Click here to pay", command  = pay, highlightbackground = 'light grey' , font = ('Times New Roman',25, 'bold')).place(relx = 1.0, rely = 1.0, anchor = 'se')
...
def pay():
    ...
    def pay_display():
        ...
        if (float(ep1.get()) == sum1):
            ...
            lp1 = Label(root10, text = 'Thank you!! Visit Again', bg = 'light grey', font = ('Times New Roman',30,'bold'), justify = 'center').place(relx = 0.55, rely = 0.6, anchor = 'ne')
    ...
    lp1 = Label(root10, text = 'Enter the amount you are paying:  ', bg = 'light grey', font = ('Times New Roman',20,'bold')).grid(row = 6, column = 5)
    ep1 = Entry(root10, width = 30, highlightbackground = 'light grey')
...
def games():
    ...
    bg1 = Button(root7, text = "Click here to play 2048 game", command = a_2048, highlightbackground = 'light grey', font = ("Times New Roman",25,"bold")).place(relx = 0.6, rely = 0.3, anchor = 'ne')
    bg2 = Button(root7, text = "Click here to play Flappy game", command = flappy, highlightbackground = 'light grey', font = ("Times New Roman",25,"bold")).place(relx = 0.6, rely = 0.4, anchor = 'ne')
    bg3 = Button(root7, text = "Click here to play Snake game", command = snake, highlightbackground = 'light grey', font = ("Times New Roman",25,"bold")).place(relx = 0.6, rely = 0.5, anchor = 'ne')
    bg4 = Button(root7, text = "Click here to track your order", command = display, highlightbackground = 'light grey', font = ("Times New Roman",25,"bold")).place(relx = 1.0, rely = 1.0, anchor = 'se')
#2048 Game
def a_2048():
